...
%
% In this project The model represents a simplified neocortical circuit containing
% cortical layers 3, 4 and 5. 
...
% Stempniewicz: l _dot_ stempniewicz2_at_ newcastle _dot_ ac _dot_ uk
 %% References	
